...
public class Similator extends ReadWriteBase {
	...
	public static void similate(Map<String, SNPHolder> snpHolderMap,
		...
		String bfout = outdir + "/" + id + "_4checkonlytest2.bam";
...
//debug
//			if(gi.getChr().contains("10")){
//				if(gi.getStart()< 93726528 && 93726528 <gi.getEnd()){
//					//continue;
...
//			}
			...
			if (cnvbean!=null||smutationExsistFlg > 0) {
...
//				rsimi.modifyReads();
				...
				ReadsSimilatorTetro rsimi = new ReadsSimilatorTetro(tgr, snpHolder, gi,
						cnv, tc, artifitialMutation, smutationExsistFlg,
						cnvbean, cnvbeanfocal, normarIte1, normalbam2);
				rsimi.modifyReads();
