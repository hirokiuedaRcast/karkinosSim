...
//		String[] ids = { "tp05" };
		...
		String answer = "/GLUSTER_DIST/data/users/ueda/karkinosSim5/text1000.vcf";
		Map<String, MutationBean> ansM = getMap(answer, 0);

		String artifitial_sub = "/GLUSTER_DIST/data/users/ueda/karkinosSim5/text1000_sub.vcf";
		...
		for (String id : ids) {
			...
			String check = "/GLUSTER_DIST/data/users/ueda/karkinosSim5/Mutect/"
					+ id + "/" + id + ".vcf";
			...
			String check2 = "/GLUSTER_DIST/data/users/ueda/karkinosSim5/karkinos/"
